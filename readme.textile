...
*REQUIREMENTS:* As of now, everything that I create (including this plugin, SocialGrid) require PHP5 to work.
...
If you encounter any problems with SocialGrid, be sure to "email me":mailto:michael@whalesalad.com or "create an issue":http://github.com/whalesalad/socialgrid/issues on Github.
